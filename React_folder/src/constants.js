...
import Endava from "./assets/work_logo/endava.png";
...
export const experiences = [
  {
    ...
    company: "Endava Solutions Private Limited",
...
export const education = [
  {
    ...
    grade: "CGPA: 8.00/10",
    desc: "I recently graduated with a Bachelor's degree in Computer Science and Design (B.E. CSD) from Sona College of Technology, Tamil Nadu. During my academic journey, I built a strong foundation in computer science through subjects such as Data Structures and Algorithms, Web Development, Database Management Systems, Software Engineering, and User Experience Design. Alongside my coursework, I worked on several hands-on projects that allowed me to apply theoretical concepts to real-world challenges. As a fresher, I am eager to leverage my technical knowledge, problem-solving abilities, and passion for learning to contribute effectively to a dynamic software development team while continuously expanding my skills.",
